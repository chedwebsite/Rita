        ...
        <div className="footer-grid">
          <div>
            ...
            <div className="socials">
              <Link href="https://x.com" target="_blank" rel="noopener noreferrer" aria-label="X / Twitter"><XIcon /></Link>
              <Link href="https://instagram.com" target="_blank" rel="noopener noreferrer" aria-label="Instagram"><InstagramIcon /></Link>
              <Link href="https://wa.me/15125550134" target="_blank" rel="noopener noreferrer" aria-label="WhatsApp"><WhatsAppIcon /></Link>
            </div>
          </div>
          <div>
            <h4>Company</h4>
